                    ...
                    <tbody>
                        @foreach ($data as $dat)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit_category', $dat->id) }}" class="btn btn-success" >Edit</a>
                                </td>
                                <td>
                                    <a href="{{ route('delete_category', $dat->id) }}" class="btn btn-danger" onclick="confirmation(event)">Delete</a>
                                </td>
