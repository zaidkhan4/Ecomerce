                    ...
                    <tbody>
                        @foreach ($brands as $brand)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit_brand', $brand->id) }}" class="btn btn-success" >Edit</a>
                                </td>
                                <td>
                                    <a href="{{ route('delete_brand', $brand->id) }}" class="btn btn-danger" onclick="confirmation(event)">Delete</a>
                                </td>
